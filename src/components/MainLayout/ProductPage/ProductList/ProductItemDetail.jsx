                ...
                <Col sm={6}>
                    <Card w={100} >
                        <Card.Body>
                            ...
                            <Card.Text className="product-item-price"> <FontAwesomeIcon icon={faUmbrella} /> Garantie 1 ans</Card.Text>

                            <Card.Text className="product-item-price"> <FontAwesomeIcon icon={faTruck} /> livrer en 7-10 jours </Card.Text>
